...
public class AddTest
{
    ...
    public void test()
    {
        Expression<BigDecimal> expression = new Add(new Constant<>(BigDecimal.valueOf(2), ExpressionType.NUMBER), new Constant<>(BigDecimal.valueOf(100), ExpressionType.NUMBER));
        BigDecimal result = expression.interpret(null);
        Assert.assertEquals(
            0,
            result.compareTo(BigDecimal.valueOf(102))
        );
    }
