...
public class DivideTest
{
    ...
    public void test()
    {
        Expression<BigDecimal> expression = new Divide(new Constant<>(BigDecimal.valueOf(100), ExpressionType.NUMBER), new Constant<>(BigDecimal.valueOf(2), ExpressionType.NUMBER));
